...
class Scoreboard(Turtle):
    def __init__(self):
        ...
        self.setpos(0, 270)
        self.score = 0
        with open("Section24FilesDirectoriesAndPaths\ReadAndWriteSnakeChallenge\data.txt") as file:
            content = file.read()
    ...
    def reset(self):
        if self.score > self.high_score:
            with open("Section24FilesDirectoriesAndPaths\ReadAndWriteSnakeChallenge\data.txt", "w") as file:
